        ...
        <div className="space-y-10 text-sm leading-relaxed" style={{ color: "#374151" }}>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-1 pl-4">
              ...
              <li><strong>Email de contacto:</strong> <a href="mailto:privacidad@mentaliasalud.online" className="underline" style={{ color: "#40916C" }}>privacidad@mentaliasalud.online</a></li>
          ...
          <section>
            ...
            <p className="mt-3" style={{ color: "#6B7280" }}>
              ...
              <a href="mailto:privacidad@mentaliasalud.online" className="underline" style={{ color: "#40916C" }}>privacidad@mentaliasalud.online</a>.
